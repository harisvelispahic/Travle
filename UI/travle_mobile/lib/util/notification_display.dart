...
/// Shared presentation helpers for notifications, used by both the list
/// ([NotificationsScreen]) and the detail ([NotificationDetailScreen]). All keys
/// are the backend `NotificationType` enum **name** (e.g. `"BookingConfirmed"`),
/// which is exactly what the API sends in `NotificationResponse.type`.
