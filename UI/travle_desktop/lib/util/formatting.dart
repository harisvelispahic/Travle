/// Small display formatters shared by the tour screens. The API sends every time
/// as a UTC instant; **event** times (tour schedule start/end) are shown in the
/// tour destination's zone via `formatEvent*` (labelled "(local time)"), while
/// audit timestamps use the device zone. The zone conversion lives in
/// `travle_core` ([eventLocalTime]/[deviceLocalTime]). See docs/time-and-timezones.md.
library;
