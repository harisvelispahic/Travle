...
/// Two-step password reset for the management app: request a code by email, then
/// set a new password with that code. On success it returns to the login screen.
/// Mirrors the mobile flow (shared [AuthProvider] endpoints), styled for desktop.
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Returning user who already has a code (closed the app while
                      // waiting): jump straight to the reset fields, keeping the email
                      // editable so they can enter it.
                      if (!_showResetFields)
                        TextButton(
                          onPressed: _busy
                              ? null
